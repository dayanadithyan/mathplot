...
def start_progress(context: bpy.types.Context, title: str = "Processing...") -> None:
    ...
    try:
        ...
        for i in range(0, total_items, chunk_size):
            ...
            for item in chunk:
                ...
                # Report progress
                if not report_progress(context, processed / total_items, 
            ...
            if modal:
                # Update UI
                context.window_manager.progress_update(int(processed / total_items * 100))
...
class ProgressThread(threading.Thread):
    ...
    def update_progress(self, progress: float, message: Optional[str] = None) -> bool:
